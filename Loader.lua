...
while task.wait() do
Library:AttemptSave()
Window:SetWindowTitle("Danny Hub - FreeMium | "..os.date('%A, %B %dth, %Y. at %H:%M:%S'))
end
end)
...
L2.Text = "Danny Hub"
L2.TextColor3 = Color3.fromRGB(0, 85, 255)
L2.TextSize = 9.000
L2.Draggable = true
sound.Parent = L2
...
_G.Config = {
  ...
  ["Fruit"] = {
    ["Auto Finding Fruit"] = false,
    ["Auto Finding Fruit Hop"] = false,
  },
}
end
...
CancelCoolDown = (function()
    ...
    if ac and ac.equipped then
        ...
        FireL = FireL + 1
        task.delay((FireCooldown or 0.01) + ((FireL + 0.01 / MaxFire) * 0.01), function()
            FireL = FireL - 1
        end)
    end
end)
AttackFunction = (function(typef)
    ...
    if ac and ac.equipped then
        ...
        if #bladehit > 0 then
            ...
            if tick() - cooldowntickFire > 0.01 then
...
function toTarget(Pos)
    if game.Players.LocalPlayer.Character.Humanoid.Health > 0 and game.Players.LocalPlayer.Character:FindFirstChild("HumanoidRootPart") then
        ...
        tween = game:GetService("TweenService"):Create(game.Players.LocalPlayer.Character.PartTele, TweenInfo.new(Distance / _G.TweenSpeed, Enum.EasingStyle.Linear),{CFrame = Pos})
        local NearestEntraceFunction = NearestEntrace(Pos)
        if plr.Data.Level.Value >= 10 then
            if _G.RandomPosition and NearestEntraceFunction then
                tween:Cancel()
                RETeleport(NearestEntraceFunction)
            end
        end
		tween:Play()
   if (_G.FastTeleport and (Distance > distbyp)) then
                    wait(2)
                    FastTeleport(Pos)
     end
tween:Play()
...
spawn(function()
    while task.wait() do
        pcall(function()
Bones555:SetText("You' now having "..CheckItem"Bones"..(" Bones"))
        end)
    end
end)
...
local EvoRaceTab = Tabs["Automatic"]:AddLeftGroupbox("« Update Race »")
...
EvoRaceTab:AddToggle('', {Text = "Auto Update Race V2",Default = _G.Config["EvoRace"]["Auto Evo Race V2"],}):OnChanged(function(Value)
...
local WeaponTab = Tabs["Automatic"]:AddLeftGroupbox("« Weapon »")

WeaponTab:AddDropdown('', {Values = {"Saber","Pole 1st Form"},Default = _G.Config["Weapon"]["Select Weapon"],Text = "Choose Weapon",}):OnChanged(function(Value)
_G.SelectSword = Value
_G.Config["Weapon"]["Select Weapon"] = Value
Saveconfig()
end)

WeaponTab:AddToggle('', {Text = "Auto Finding Weapon",Default = _G.Config["Weapon"]["Auto Weapon"],}):OnChanged(function(Value)
_G.AutoFullySword = Value
_G.Config["Weapon"]["Auto Weapon"] =  Value
Saveconfig()
end)
       ...
       spawn(function()
        while task.wait() do
            if _G.SelectSword == "Saber" and _G.AutoFullySword and game.Players.LocalPlayer.Data.Level.Value >= 200 and World1 then
                ...
                wait(.1)
                repeat wait(.1)
                    Tween(game:GetService("Workspace").Map.Jungle.QuestPlates.Plate1.Button.CFrame)
                ...
                wait(.1)
                repeat wait(.1)
                    Tween(game:GetService("Workspace").Map.Jungle.QuestPlates.Plate2.Button.CFrame)
                ...
                wait(.1)
                repeat wait(.1)
                    Tween(game:GetService("Workspace").Map.Jungle.QuestPlates.Plate3.Button.CFrame)
                ...
                wait(.1)
                repeat wait(.1)
                    Tween(game:GetService("Workspace").Map.Jungle.QuestPlates.Plate4.Button.CFrame)
                ...
                wait(.1)
                repeat wait(.1)
                    Tween(game:GetService("Workspace").Map.Jungle.QuestPlates.Plate5.Button.CFrame)
...
Tween(v.HumanoidRootPart.CFrame * CFrame.new(0,40,0))
                                                ...
                                                if game:GetService("ReplicatedStorage"):FindFirstChild("Mob Leader") then
                                                    Tween(game:GetService("ReplicatedStorage"):FindFirstChild("Mob Leader").HumanoidRootPart.CFrame * CFrame.new(0,40,0))
                                                end
                                            end
                                        end
                                     end
...
Tween(v.HumanoidRootPart.CFrame * CFrame.new(0,40,0))
                        ...
                        if game:GetService("ReplicatedStorage"):FindFirstChild("Saber Expert") then
                            Tween(game:GetService("ReplicatedStorage"):FindFirstChild("Saber Expert").HumanoidRootPart.CFrame * CFrame.new(0,40,0))
end
                                        end
                                    end
                                end
...
local FruitTab = Tabs["Automatic"]:AddLeftGroupbox("« Fruit »")

FruitTab:AddToggle('',{Text = "Auto Finding Fruit",Default = _G.Config["Fruit"]["Auto Finding Fruit"],}):OnChanged(function(Value)
_G.Config["Fruit"]["Auto Finding Fruit"] =  Value
Saveconfig()
end)
...
FruitTab:AddToggle('',{Text = "Auto Finding Fruit",Default = _G.Config["Fruit"]["Auto Finding Fruit Hop"],}):OnChanged(function(Value)
_G.TelepiToFutHop =  Value
_G.Config["Fruit"]["Auto Finding Fruit Hop"] =  Value
Saveconfig()
end)
